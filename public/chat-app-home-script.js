   ...
   socket.on("new user", function(data) { 
     ...
     listOfUsersToChat.push(`<div class="user"><img id="user-image" src="https://${window.location.hostname}public/images/people-group-avatar.png" alt=""><div id="user-name">General<span class="message_notification" style="display:inline;">${unreadMsgs.General.unreadMsgCount}</span><br><em>General Chat-room.</em></div></div>`);
   ...
   if(chatEntity.lastElementChild.textContent === 'General') {
    unreadMsgs.General.unreadMsgCount = 0;
    listOfUsersToChat[0] = `<div class="user"><img id="user-image" src="https://${window.location.hostname}public/images/people-group-avatar.png" alt=""><div id="user-name">General<span class="message_notification" style="display:none;"></span><br><em>General Chat-room.</em></div></div>`;
    userListForPrivateChat.innerHTML = listOfUsersToChat.join("");
    conversationContainer.innerHTML = generalRoomConversation.join("");
    conversationContainer.scrollTop = conversationContainer.scrollHeight + 5;
   } else {
     ...
     listOfUsersToChat[0] = `<div class="user"><img id="user-image" src="https://${window.location.hostname}public/images/people-group-avatar.png" alt=""><div id="user-name">General<span class="message_notification" style="display:inline;">${unreadMsgs.General.unreadMsgCount}</span><br><em>General Chat-room.</em></div></div>`
     userListForPrivateChat.innerHTML = listOfUsersToChat.join("");
   }
 });
